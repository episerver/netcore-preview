...
namespace EPiServer.Reference.Commerce.Site.Features.Recommendations.Services
{
    ...
    public class RecommendationService : IRecommendationService
    {
        ...
        public async Task<TrackingResponseData> TrackProductAsync(HttpContext httpContext, string productCode, bool skipRecommendations)
        {
        ...
        public async Task<TrackingResponseData> TrackSearchAsync(HttpContext httpContext, string searchTerm, IEnumerable<string> productCodes, int totalRecordsCount)
        {
        ...
        public async Task<TrackingResponseData> TrackOrderAsync(HttpContext httpContext, IPurchaseOrder order)
        {
            if (_contextModeResolver.CurrentMode != ContextMode.Default)
            {
                return null;
        ...
        public async Task<TrackingResponseData> TrackCategoryAsync(HttpContext httpContext, NodeContent category)
        {
            if (_contextModeResolver.CurrentMode != ContextMode.Default)
            {
                return null;
        ...
        public async Task<TrackingResponseData> TrackCartAsync(HttpContext httpContext) =>
            await TrackCartAsync(httpContext, Enumerable.Empty<CartChangeData>());

        public async Task<TrackingResponseData> TrackCartAsync(HttpContext httpContext, IEnumerable<CartChangeData> cartChanges)
        {
            if (_contextModeResolver.CurrentMode != ContextMode.Default)
            {
                return null;
        ...
        public async Task<TrackingResponseData> TrackWishlistAsync(HttpContext httpContext)
        {
            if (_contextModeResolver.CurrentMode != ContextMode.Default)
            {
                return null;
        ...
        public async Task<TrackingResponseData> TrackCheckoutAsync(HttpContext httpContext)
        {
            if (_contextModeResolver.CurrentMode != ContextMode.Default)
            {
                return null;
