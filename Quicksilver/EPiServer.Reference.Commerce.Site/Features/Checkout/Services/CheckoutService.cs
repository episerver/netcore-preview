...
namespace EPiServer.Reference.Commerce.Site.Features.Checkout.Services
{
    ...
    public class CheckoutService
    {
        ...
        public virtual void CreateAndAddPaymentToCart(ICart cart, CheckoutViewModel viewModel, Dictionary<string, string> additionalPaymentData)
        {
        ...
        public void ProcessPaymentCancel(CheckoutViewModel viewModel, ITempDataDictionary tempData, ControllerContext controlerContext)
        {
            var message = tempData["message"]?.ToString() ?? controlerContext.HttpContext.Request.Query["message"];
