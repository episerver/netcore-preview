...
namespace EPiServer.Reference.Commerce.Shared.CatalogIndexer
{
    public class RestIndexer : CatalogIndexBuilder, IDisposable
    {
        ...
        {
            _url = VirtualPathUtilityEx.AppendTrailingSlash(ConfigurationManager.AppSettings["SearchApiUrl"]);
            _url = ConfigurationManager.AppSettings["SearchApiUrl"].ToString();
        }
